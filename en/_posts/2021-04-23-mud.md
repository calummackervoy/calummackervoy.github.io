...
For the unitiated I've prepared a brief intro on the basics of the semantic web. If you already know about all that, then please skip ahead.

<button type="button" class="collapsible-target" data-target="#semantic-web-intro" data-toggle="collapse" aria-expanded="false" aria-controls="semantic-web-intro">Introduce me</button>
